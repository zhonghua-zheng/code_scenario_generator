...
# 2) Latitude
Latitude_min = 60.0; Latitude_max = 89.999; #1
# 3) Day of Year 
...
# Gas phase emissions
# 1) SO2
SO2_emit_min = 0; SO2_emit_max = 1; #4
# 2) NO2
NO2_emit_min = 0; NO2_emit_max = 1; #5
# 3) NO
NO_emit_min = 0; NO_emit_max = 1; #6
# 4) NH3
NH3_emit_min = 0; NH3_emit_max = 1; #7
# 5) CO
CO_emit_min = 0; CO_emit_max = 1; #8
# 6) ALD2
ALD2_emit_min = 0; ALD2_emit_max = 1; #9
# 7) HCHO
HCHO_emit_min = 0; HCHO_emit_max = 1; #10
# 8) ETH
ETH_emit_min = 0; ETH_emit_max = 1; #11
# 9) OLEI
OLEI_emit_min = 0; OLEI_emit_max = 1; #12
# 10) OLET
OLET_emit_min = 0; OLET_emit_max = 1; #13
# 11) TOL
TOL_emit_min = 0; TOL_emit_max = 1; #14
# 12) XYL
XYL_emit_min = 0; XYL_emit_max = 1; #15
# 13) AONE
AONE_emit_min = 0; AONE_emit_max = 1; #16
# 14) PAR
PAR_emit_min = 0; PAR_emit_max = 1; #17
# 15) ISOP 
ISOP_emit_min = 0; ISOP_emit_max = 1; #18
# 16) CH3OH
CH3OH_emit_min = 0; CH3OH_emit_max = 1; #19
# 17) ANOL
ANOL_emit_min = 0; ANOL_emit_max = 1; #20
# 18) DMS
DMS_emit_min = 0; DMS_emit_max = 1; #40
...
# 6) Ea2
Ea2_sse_min = 0; Ea2_sse_max = 2.38e3; #31
# 7) OC_2 fraction
OC_2_fra_min = 0; OC_2_fra_max = 0.2; #32

# Aitken_seasalt Emissions
# 1) Dg1
Dg_seasalt_min = 1.5e-08; Dg_seasalt_max = 5.3e-08; #33
# 2) sigmag1
sigmag_seasalt_min = 1.6; sigmag_seasalt_max = 1.6; #34
# 3) Ea1
Ea_seasalt_min = 0; Ea_seasalt_max = 2.0e8; #35

# Aitken_sulfate Emissions
# 1) Dg1
Dg_sulfate_min = 1.5e-08; Dg_sulfate_max = 5.3e-08; #36
# 2) sigmag1
sigmag_sulfate_min = 1.6; sigmag_sulfate_max = 1.6; #37
# 3) Ea1
Ea_sulfate_min = 0; Ea_sulfate_max = 2.0e9; #38
...
lhs_min = np.asarray([RH_min, Latitude_min, DOY_min, Temp_min, 
           ...
           Dg_seasalt_min, sigmag_seasalt_min, Ea_seasalt_min, Dg_sulfate_min, sigmag_sulfate_min, Ea_sulfate_min, 
...
lhs_max = np.asarray([RH_max, Latitude_max, DOY_max, Temp_max, 
           ...
           Dg_seasalt_max, sigmag_seasalt_max, Ea_seasalt_max, Dg_sulfate_max, sigmag_sulfate_max, Ea_sulfate_max, 
...
for i in range (lhs.shape[0]):
    ...
    shutil.copy("./dat_files/aero_emit_comp_Aitken_seasalt.dat",directory+"/aero_emit_comp_Aitken_seasalt.dat")
    shutil.copy("./dat_files/aero_emit_comp_Aitken_sulfate.dat",directory+"/aero_emit_comp_Aitken_sulfate.dat")
